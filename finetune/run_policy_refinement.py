...
def parse_args():
    ...
    parser.add_argument("--proj_name", type=str, default="PPO-TSCS")
...
def main(in_args):
    ...
    in_args.cgpr_data_path = in_args.traffic_file
    ...
    dic_agent_conf_extra = {
        ...
        "LLM_OUTPUT_DIR": in_args.llm_output_dir,
        "LOG_DIR": f"./{in_args.llm_model}_logs",
        "BATCH_SIZE": in_args.batch_size,
        "MINI_BATCH_SIZE": in_args.mini_batch_size,
        "GRADIENT_ACCUMULATION_STEPS": in_args.gradient_accumulation_steps,
        "LEARNING_RATE": in_args.learning_rate,
        "NEW_MAX_TOKENS": in_args.new_max_tokens,
        "CGPR_DATA_PATH": in_args.cgpr_data_path,
    ...
    trainer = Trainer(dic_agent_conf_extra,
